...
// neither says anything about a module arriving. This does, so growing the
// dependency graph is a decision rather than a diff.
...
// so it resolves under GOPROXY=off rather than skipping when the module cache
// is unavailable.
